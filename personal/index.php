            ...
            <div class="mb-4">
                ...
                <div class="collapse" id="userAnnouncementList">
                    <div class="mb-2">
                        <table class="w-100">
                            <tbody>
                            <th class="text-right pr-3"><?= Loc::getMessage('AUTO'); ?></th>
                            <tr class="d-flex">
                            ...
                            <? foreach ($arPaket as $arItem) { ?>
                                <? if ($arItem['UF_COUNT_REMAIN'] > 0 && $arItem['UF_TYPE'] == 'AUTO') { ?>
                                    <tr class="d-flex">
                                        <td class="d-flex flex-column flex-lg-row justify-content-center">
                                            <div class="ml-auto d-flex justify-content-end align-items-center justify-content-lg-center font-weight-bold">
                                                <span class="ml-1"><?= $arItem['UF_COUNT_REMAIN'] ?></span><?= Loc::getMessage('OF_COUNT'); ?>
                                                <span class="mr-1"><?= $arItem['UF_COUNT_LESS'] ?></span></div>
                                        </td>
                    ...
                    <div class="mb-2">
                        <table class="w-100">
                            <tbody>
                            <th class="text-right pr-3"><?= Loc::getMessage('PROPERTY'); ?></th>
                            <tr class="d-flex">
                                <td class="d-flex flex-column flex-lg-row justify-content-end">
                                    <div class="m-0 mr-lg-4 d-flex align-items-center justify-content-end justify-content-lg-center category">
                                    ...
                                    <div class="d-flex justify-content-end align-items-center justify-content-lg-center font-weight-bold">
                                        ...
                                        <span class="mr-1"><?= ($arUser['UF_COUNT_APART'] < 1) ? "0" : $arUser['UF_COUNT_APART']; ?></span>
                                    </div>
                                </td>

                                <td class="d-flex justify-content-center align-items-center date-announcment"><span><? if (reCount($arUser['UF_COUNT_ITEM_PROP']) > 0) { ?>
                                            (  <?= date("d.m.Y H:i:s", strtotime('+ ' . $arUser['UF_DAYS_PROP_REMAIN'] . ' days')) ?>)
                                        <? } else { ?>
                                            -
                                        <? } ?></span>
                                </td>
                            ...
                            <? foreach ($arPaket as $arItem) { ?>
                                <? if ($arItem['UF_COUNT_REMAIN'] > 0 && $arItem['UF_TYPE'] == 'Prop') { ?>
                                    <tr class="d-flex">
                                        <td class="d-flex flex-column flex-lg-row justify-content-center">
                                            <div class="ml-auto d-flex justify-content-end align-items-center justify-content-lg-center font-weight-bold">
                                                <span class="ml-1"><?= $arItem['UF_COUNT_REMAIN'] ?></span> <?= Loc::getMessage('OF_COUNT'); ?>
                    ...
                    <div class="mb-2">
                        <table class="w-100">
                            <tbody>
                            <th class="text-right pr-3"><?= Loc::getMessage('FLEA'); ?></th>
                            <tr class="d-flex">
                                <td class="d-flex flex-column flex-lg-row justify-content-end">
                                    <div class="m-0 mr-lg-4 d-flex align-items-center justify-content-end justify-content-lg-center category">
                                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/announsment-list-free.svg"
                                             alt=""></div>
                                    <div class="d-flex justify-content-end align-items-center justify-content-lg-center font-weight-bold">
                                        <span class="ml-1"><?= $arUser['UF_DAYS_FREE1'] ?></span> <?= Loc::getMessage('OF_COUNT'); ?>
                                        <span class="mr-1"><?= ($arUser['UF_COUNT_FLEA'] < 1) ? "0" : $arUser['UF_COUNT_FLEA']; ?></span>
                                    </div>
                                </td>

                                <td class="d-flex justify-content-center align-items-center date-announcment"><span><? if (reCount($arUser['UF_COUNT_ITEM_FLEA']) > 0) { ?>
                                            (  <?= date("d.m.Y H:i:s", strtotime('+ ' . $arUser['UF_DAYS_FLEA_REMAIN'] . ' days')) ?>)
                                        <? } else { ?>
                                            -
                                        <? } ?></span>
                                </td>
                            ...
                            <? foreach ($arPaket as $arItem) { ?>
                                <? if ($arItem['UF_COUNT_REMAIN'] > 0 && $arItem['UF_TYPE'] == 'FLEA') { ?>
                                    <tr class="d-flex">
                                        ...
                                        <td class="d-flex justify-content-center align-items-center date-announcment">
                                            <span>(  <?= date("d.m.Y H:i:s", strtotime('+ ' . $arItem['UF_DAYS_REMAIN'] . ' day')) ?>)</span>
                                        </td>
                                    </tr>
                                <? }
                            } ?>
