...
$mapLatlnt = json_decode($arResult['~PROPERTY_197'], true);
...
<div class="row flex-column-reverse flex-lg-row mb-4">
    <div class="col-12 col-lg-4 flex-column">
        <div class="d-lg-block">
            <?php if (!$arParams['USER_ID']) { ?>
                <div class="mb-4 card connection-with-seller text-right 1">
                    ...
                    <?php if ($arResult['PROPERTIES']['LOCALITY']['VALUE']) { ?>
            ...
            <?php } elseif ($arParams['USER_ID'] == $arResult['PROPERTIES']['ID_USER']['VALUE']) { ?>
                <div class="mb-4 card connection-with-seller text-right 2">
                    <h1 class="mb-4 connection-with-seller__title"><?= $arResult['NAME']; ?></h1>
                    <p class="mb-4 connection-with-seller__price text-primary">
                        <?= number_format($arResult['PROPERTIES']['PRICE']['VALUE'], 0, '.', ' '); ?> <?= ICON_CURRENCY; ?>
                    </p>
                                        ...
                                        <div class="p-3 bg-lightgray">
                                            ...
                                            <form id="formProdactRise1">
                                                <div class="mb-4 px-3 card">
                                                    <?php foreach ($arResult['SPEED_UP_SALE']['RISES'] as $arRise) { ?>
                                                        <?php if ($arRise['UF_COUNT'] > 0) { ?>
                                                ...
                                                <div class="d-flex flex-column justify-content-end align-items-end">
                                                    ...
                                                    <button type="button"
                                                            onclick="countRiseBuyShek(<?= $arResult['ID'] ?>, $('#formProdactRise<?= $arResult['ID'] ?>'), <?= $arResult['IBLOCK_ID'] ?>)"
                                    ...
                                    <div id="vipItem<?= $arResult['ID'] ?>" class="collapse"
                                        ...
                                        <div class="p-3 bg-lightgray">
                                            ...
                                            <form id="formProdactVip1">
                                                <div class="mb-4 px-3 card">
                                                    <?php foreach ($arResult['SPEED_UP_SALE']['VIPS'] as $arRise) { ?>
                                                        <?php if ($arRise['UF_COUNT'] > 0) { ?>
                                                            <div class="py-3 border-bottom d-flex justify-content-between">
                                                                <span class="font-weight-bold"><?= $arRise["UF_PRICE"] ?> T</span>
                                    ...
                                    <div id="selectColorItem<?= $arResult['ID'] ?>" class="collapse"
                                        ...
                                        <div class="p-3 bg-lightgray">
                                            ...
                                            <form id="formProdactColour1">
                                                <div class="mb-4 px-3 card">
                                                    <?php foreach ($arResult['SPEED_UP_SALE']['COLORS'] as $arRise) { ?>
                                                        <?php if ($arRise['UF_COUNT'] > 0) { ?>
                                                            <div class="py-3 border-bottom d-flex justify-content-between">
                                                                <span class="font-weight-bold"><?= $arRise["UF_PRICE"] ?> T</span>
                                    ...
                                    <div id="selectRiddonItem<?= $arResult['ID'] ?>" class="collapse"
                                        ...
                                        <div class="p-3 bg-lightgray">
                                            ...
                                            <form id="formProdactLent1">
                                                <div class="mb-4 px-3 card">
                                                    <?php foreach ($arResult['SPEED_UP_SALE']['RIBBONS'] as $arRise) { ?>
                                                        <?php if ($arRise['UF_COUNT'] > 0) { ?>
                                                            <div class="py-3 border-bottom d-flex justify-content-between">
                                                                <span class="font-weight-bold"><?= $arRise["UF_PRICE"] ?> T</span>
                                        ...
                                        <div class="p-3 bg-lightgray">
                                            ...
                                            <form id="formProdactPaket1">
                                                <div class="mb-4 px-3 card"
                                                    ...
                                                    <?php foreach ($arResult['SPEED_UP_SALE']['SETS'] as $arRise) { ?>
                                                        <?php if ($arRise['UF_PRICE'] > 0) { ?>
                                                            <div class="py-3 border-bottom d-flex justify-content-between"
                                                                 id="tipe1">
                                                                <span class="font-weight-bold"><?= $arRise['UF_PRICE'] ?> T</span>
            ...
            <?php } else { ?>
                <div class="mb-4 card connection-with-seller text-right 3">
                    <h1 class="mb-4 connection-with-seller__title"><?= $arResult['NAME']; ?></h1>
                    <p class="mb-4 connection-with-seller__price text-primary">
                        <?= number_format($arResult['PROPERTIES']['PRICE']['VALUE'], 0, '.', ' '); ?> <?= ICON_CURRENCY; ?>
                    </p>
        ...
        <div class="mb-4 card seller-card text-right">
            ...
            <button class="w-100 btn btn-primary text-uppercase btn-author-add">
                <a href="/search/author/?R=<?= $arResult['IBLOCK_ID'] ?>&I=<?= $arResult['PROPERTIES']['ID_USER']['VALUE'] ?>&sort=price_d&display=block">
    ...
    <div class="col-12 col-lg-8">
        <div class="item-slider">
          <span class="add-item-favorite">
            ...
            <div class="slider-for">
                <?php foreach ($arResult['PHOTOS'] as $k => $item):?>
                ...
                <div class="modal-dialog m-0 mw-100" role="document">
                    <div class="modal-content bg-transparent">
                        <div class="fullScreenItemModal">
                            <button type="button" class="m-0 mr-auto close" data-dismiss="modal"
                                    aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                                        ...
                                        <?php } elseif ($arParams['USER_ID'] == $arResult['PROPERTIES']['ID_USER']['VALUE']) { ?>
                                            <div class="mb-4 card connection-with-seller text-right 5">
                                                ...
                                                <div class="flex-column">
                                                    ...
                                                    <button class="w-100 btn btn-accelerate-sale text-uppercase font-weight-bold btn-accelerate-sale">
                                                        <span>
                                                                    ...
                                                                    <div class="p-3 bg-lightgray">
                                                                        ...
                                                                        <form id="formProdactRise2">
                                                                            ...
                                                                            <div class="d-flex flex-column justify-content-end align-items-end">
                                                                                ...
                                                                                <button type="button" onclick="countRiseBuyShek(<?= $arResult['ID'] ?>, $('#formProdactRise<?= $arResult['ID'] ?>'), <?= $arResult['IBLOCK_ID'] ?>)"
                                                                                        class="btn btn-primary btn-paid">
                                                                                    <span class="mr-2">
                                                                                        <svg width="17"
                                                                                                height="14"
        ...
        <div style="display: none !important;" class="d-block d-lg-none">
            ...
            <?php if (!$arParams['USER_ID']) { ?>
                <div class="mb-4 card connection-with-seller text-right 7">
                    <h1 class="mb-4 connection-with-seller__title"><?= $arResult['NAME']; ?></h1>
            ...
            <?php } elseif ($arParams['USER_ID'] == $arResult['PROPERTIES']['ID_USER']['VALUE']) { ?>
                <div class="mb-4 card connection-with-seller text-right 8">
                    <h1 class="mb-4 connection-with-seller__title"><?= $arResult['NAME']; ?></h1>
            ...
            <?php } else { ?>
                ...
                <div class="mb-4 card connection-with-seller text-right 9">
                    <h1 class="mb-4 connection-with-seller__title"><?= $arResult['NAME']; ?></h1>
                    ...
                    <div class="row no-gutters">
                        <button class="mr-2 col btn btn-show-phone text-uppercase font-weight-bold"
                                data-toggle="collapse" href="#showContactPhone" role="button"
                                aria-expanded="false"
                                aria-controls="showContactPhone"><?= Loc::getMessage('SHOW_PHONE'); ?>
                        </button>
            ...
            <div class="card p-4">
                <table class="property-item-table table">
                    ...
                    <?php foreach ($arResult['PROPERTIES'] as $PROPERTY) { ?>
                        ...
                        if ($pos === false && $PROPERTY['MULTIPLE'] != 'Y') {
                        } else {
                            if ($PROPERTY['VALUE'] == '') {

                            } else {
                                if ($PROPERTY['CODE'] == 'PHOTOS') {
                                    ...
                                    <tr>
                                        <td><?php if (is_array($PROPERTY['VALUE'])) {
