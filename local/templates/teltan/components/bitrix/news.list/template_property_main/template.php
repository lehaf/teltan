        ...
        <?foreach ($arResult['ITEMS'] as $arItem){
            ...
            <div class="mb-4 col" id="<?=$this->GetEditAreaID($arItem['ID'])?>">
                ...
                if($arItem['PROPERTIES']['COLOR_DATE']['VALUE'] && strtotime($arItem['PROPERTIES']['COLOR_DATE']['VALUE']) > time())
                    $color = '#FFF5D9';
                ?>
                <div class="card product-card property-product" style="background-color: <?=$color;?>">
                    <div class="card-link">
                        <div class="image-block">
                            <div class="i-box">
                                <a href="<?=$arItem['DETAIL_PAGE_URL'];?>"><img src="<?=$arItem['PREVIEW_450_377'];?>" alt="<?=$arItem['NAME'];?>"></a>
                            </div>
                        </div>
