        ...
        <?foreach ($arResult['ITEMS'] as $arItem){?>
            <div class="mb-4 col">
                <div class="big-card-product auto-product">
                    ...
                    <div   class="image-box">
                        <img src="<?=$arItem['PREVIEW_450_377'];?>" alt="<?=$arItem['NAME'];?>">
                    </div>
                    <div class="data">
                        <?if($arItem['SHOW_COUNTER']){?>
                            <span class="mr-2"><span class="views"><?=$arItem['SHOW_COUNTER'];?></span> <i class="icon-visibility"></i></span>
                        <?}?>
                        <?
                    ...
                    <div class="info d-flex flex-column flex-lg-row">
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="text-right">
                                <a href="<?=$arItem['DETAIL_PAGE_URL'];?>" class="title text-uppercase"><?=$arItem['NAME'];?></a>
...
<?}?>
<script>$('.image-box').click(function () {
        alert('34');
    })</script>
