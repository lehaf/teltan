    ...
    <div class="vip-items-slider">
        <?foreach ($arResult['ITEMS'] as $arItem){?>
            ...
            if($arItem['PROPERTIES']['COLOR_DATE']['VALUE'] && strtotime($arItem['PROPERTIES']['COLOR_DATE']['VALUE']) > time())
                $color = '#FFF5D9';
            ?>
            <div class="card product-card item-vip-slider item-vip-slider_full-image" style="background-color:<?=$color;?>">
                <div class="image-block">
                    <div class="i-box">
                        <a href="<?=$arItem['DETAIL_PAGE_URL'];?>"><img src="<?=$arItem['PREVIEW_203_179'];?>" alt="<?=$arItem['NAME'];?>"></a>
                    </div>
                </div>
                ...
                <div class="px-2 px-lg-3 content-block">
                    ...
                    <div class="d-flex flex-column text-right">
                        <a href="<?=$arItem['SECTION']['SECTION_PAGE_URL'];?>" class="category"><?=$arItem['SECTION']['NAME'];?></a>
