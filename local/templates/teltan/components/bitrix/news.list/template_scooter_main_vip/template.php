        ...
        <? foreach ($arResult['ITEMS'] as $arItem) {
            ...
            <div class="mb-4 col" id="<?=$this->GetEditAreaID($arItem['ID'])?>">
                <div class="big-card-product auto-product">
                    ...
                    <div class="image-box">
                        <img onclick="window.location.href='<?=$arItem['DETAIL_PAGE_URL'];?>'" src="<?= $arItem['PREVIEW_450_377']; ?>" alt="<?= $arItem['NAME']; ?>">
                    </div>
                    <div class="data">
                            ...
                            <div class="text-right">
                                ...
                                <p class="mb-2 text-with-icon">
                                    <? if ($arItem['PROPERTIES']['PROP_PROBEG']['VALUE'] != null) {
                                        ?>
                                        <span><?= number_format($arItem['PROPERTIES']['PROP_PROBEG']['VALUE'], 0, '.', ' '); ?> <?= $arItem['PROPERTIES']['KM_ML']['VALUE'] ?></span>
