            ...
            <div class="card product-card item-vip-slider item-vip-slider_full-image"
                ...
                <div class="px-2 px-lg-3 content-block">
                    ...
                    <div class="d-flex flex-column text-right">
                        <? if ($arItem['PROPERTIES']['PROP_BRAND']['VALUE'] != null) { ?>
                            <? $arSectionData = [];
                            ...
                            if ($ar_res = $res->GetNext()) {
                                ...
                                if (!$ar_res['IBLOCK_SECTION_ID']) {
                                    ...
                                    $parenRes = CIBlockSection::GetByID($ar_res["IBLOCK_SECTION_ID"]);
                                    if ($ar_pres = $parenRes->GetNext())
                                        $arSectionData[] = $ar_pres;
                                }
                            } ?>
                            <a href="<?= $arSectionData[0]['~SECTION_PAGE_URL'] ?>/"
                               class="category"><?= $arSectionData[0]['~NAME'] ?></a>
                        <?
                        } else { ?>
                        <? $arSectionData = [];
                        $res = CIBlockSection::GetByID($arItem["IBLOCK_SECTION_ID"]);
