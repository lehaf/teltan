                        ...
                        <div class="card-link">
                            ...
                            <div class="px-2 px-lg-3 content-block">
                                ...
                                <div class="border-top py-2 d-flex justify-content-between align-items-center text-nowrap product-line__data-viwe">
                                    ...
                                    <?php
                                    $strDate = getStringDate($item['PROPERTIES']['TIME_RAISE']['VALUE']);
                                    ?>
            ...
            <div class="mb-4 col" id="<?=$this->GetEditAreaID($item['ID'])?>">
                <div class="card product-card auto-product <?=$arParams['IMG_VIEW'] !== 'CONTAINER' ? 'property-product' : ''?>"
                    ...
                    <div class="image-block">
                        <div class="i-box">
                            <a href="<?=$item['DETAIL_PAGE_URL']?>">
                                <img src="<?=$itemCounter >  4 ? $pixel : $item['PREVIEW_PICTURE']['src']?>"
                                     data-defer-src="<?=$item['PREVIEW_PICTURE']['src']?>"
                                     alt="<?=$item['NAME']?>"
                                     title="<?=$item['NAME']?>"
                                >
                    ...
                    <div class="px-2 px-lg-3 content-block">
                        <div class="text-right">
                            ...
                            <?php endif;?>
                            <?php if ($arParams['CATEGORY'] !== AUTO_ADS_TYPE_CODE && !empty($item['SECTION'])):?>
                                <a class="mb-2 mb-lg-4 category" href="<?=$item['SECTION']['SECTION_PAGE_URL']?>">
                                    <?=$item['SECTION']['NAME']?>
                                </a>
                            <?php endif;?>
                        </div>
                        <div class="<?=$arParams['CATEGORY'] !== AUTO_ADS_TYPE_CODE ? 'mt-3' : ''?> border-top py-2 py-lg-3 d-flex justify-content-between align-items-center text-nowrap">
                            <span class="mr-0 mr-lg-2 views">
