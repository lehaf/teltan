...
else
{
    ...
    <div class="container">
        ...
        if ($_GET['CONTRACT'] == 'Y'){
            $comp = "medialine:service.auction.view";
            $tmpl = !empty($_GET['CONTRACT'])?"smartContract":"";
            ?>
            <div class="request-container"><?$ElementID = $APPLICATION->IncludeComponent(
                $comp,
                $tmpl,
                Array(
                    ...
                    'READ_ONLY' => !empty($_GET['UPDATE'])?"N":"Y",
                    'MODERATION' => 'N',
                ),
                $component
            );?></div><?
