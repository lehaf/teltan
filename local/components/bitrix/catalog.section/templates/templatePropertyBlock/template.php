...
<?if($_GET['TEST']== 'Y'){?>
<pre>
    <?=print_r($arResult['ITEMS'][0]['PROPERTIES'])?>
</pre><?=Loc::getMessage('zhilaya');?>
<?}?>
<?
...
<div class="property-map">
    ...
    <button onclick="window.location.href ='?view=maplist'" class="show-all-items"><a href="?view=maplist"><?=Loc::getMessage('map');?></a> </button>
</div>
