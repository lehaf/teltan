// const UserFavoriteAds = function () {
//     this.settings = {
...
// }
//
// UserFavoriteAds.prototype.init = function () {
//     this.setEventTabs();
//     this.setEventPagination();
// }
//
// UserFavoriteAds.prototype.setEventTabs = function () {
//     const _this = this;
//
...
// }
//
// UserFavoriteAds.prototype.setEventPagination = function () {
//     const _this = this;
...
// }
//
// UserFavoriteAds.prototype.showLoader = function () {
//     if (this.$loader) {
...
// }
//
// UserFavoriteAds.prototype.hideLoader = function () {
//     if (this.$loader) {
//         this.$loader.removeAttribute('style');
//     }
// }
//
// UserFavoriteAds.prototype.getDomElementsFromString = function (string) {
//     let obDomParser = new DOMParser();
//     return obDomParser.parseFromString(string, "text/html");
// }
//
// UserFavoriteAds.prototype.sendData = function (data, link = location.href) {
//     const _this = this;
//     fetch(link, {
//         method: 'POST',
//         cache: 'no-cache',
