...
$canUserCreateAds = canUserCreateAds(PROPERTY_ADS_IBLOCK_ID,PROPERTY_ADS_TYPE_CODE);
...
if ($canUserCreateAds || $_REQUEST['EDIT'] == 'Y') {
    ...
    if ($_REQUEST['EDIT'] != 'Y') {
        ...
        if (isExistActiveFreeAd(PROPERTY_ADS_TYPE_CODE) === false) {
            removeFreeAdPropOnAds(PROPERTY_ADS_TYPE_CODE);
            $isFreeAdd = true;
            $arLoadProductArray['PROPERTY_VALUES']['FREE_AD'] = getPropertyFreeAdValueId(PROPERTY_ADS_IBLOCK_ID);
    ...
    if ($_REQUEST['EDIT'] != 'Y') {
        ...
        if ($res = $el->Update(intval($_REQUEST['EDIT_ID']), $arLoadProductArray)) {
            ...
            $arLoadProductProps = array
            (
                'UF_SELLER_TYPE' => $arLoadProductProp['UF_SELLER_TYPE'],
            );
