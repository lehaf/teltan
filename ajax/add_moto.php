...
$canUserCreateAds = canUserCreateAds(MOTO_IBLOCK_ID,AUTO_ADS_TYPE_CODE);
...
if ($canUserCreateAds || $_REQUEST['EDIT'] == 'Y') {
    ...
    if ($_REQUEST['EDIT'] != 'Y') {
        ...
        if (isFreeAddCreated(AUTO_ADS_TYPE_CODE) === false) {
            $isFreeAdd = true;
            $arLoadProductArray['PROPERTY_VALUES']['FREE_AD'] = getPropertyFreeAdValueId(MOTO_IBLOCK_ID);
    ...
    // Редактирование элемента
        ...
        if($res = $el->Update(intval($_REQUEST['EDIT_ID']), $arLoadProductArray)){
            ...
            $arLoadProductArray['PROP_BODY_TYPE'] =  $_REQUEST['PROP_BODY_TYPE'];
