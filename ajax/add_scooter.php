...
$canUserCreateAds = canUserCreateAds(SCOOTER_IBLOCK_ID,AUTO_ADS_TYPE_CODE);
...
if ($canUserCreateAds || $_REQUEST['EDIT'] == 'Y') {
    ...
    if ($_REQUEST['EDIT'] != 'Y') {
        ...
        if (isFreeAddCreated(AUTO_ADS_TYPE_CODE) === false) {
            $isFreeAdd = true;
            $arLoadProductArray['PROPERTY_VALUES']['FREE_AD'] = getPropertyFreeAdValueId(SCOOTER_IBLOCK_ID);
