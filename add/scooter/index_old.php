                        ...
                        <div>
                            ...
                            <div class="wizard-content" data-wizard-content="1">
                                <div class="auto-step2">
                                    ...
                                    <div class="mb-4 mb-lg-5 row row-cols-lg-5 wrapper-brand-items">
                                        <?
                                        ...
                                        while ($row = $res->GetNext()) {
                                            ...
                                            if ($arParentSection = $rsParentSection->GetNext()) {
                                                ...
                                                while ($arSect = $rsSect->GetNext()) {
                                                    ...
                                                    $arSubSections[$arSect['NAME']]['PARENT_SECTION'] = $row;
                                                ...
                                                <div class="form_radio_btn">
                                                    <input
                                                        ...
                                                        <?= ($arSection['NAME'] == $arProps['PROP_BRAND']['VALUE']) ? 'checked' : '' ?>
                                                            data-req="Y" type="radio" class="d-none"
                            ...
                            <div class="wizard-content" data-wizard-content="2">
                                <div class="auto-step2">
                                    ...
                                    <div id="row-cols-lg-6" class="mb-4 mb-lg-5 row row-cols-lg-6">
                                ...
                                <div class="auto-ad-step2-3">
                                    ...
                                    <div class="mb-4 row">
                                        <div class="col-12 col-lg-10">
                                            <div class="d-none d-lg-flex justify-content-end align-items-center <?= ($prop_field[119]['IS_REQUIRED'] == 'Y') ? 'div-req' : '' ?>">
                                                <? $count = 0; ?>
                                                ...
                                                <? if ($item['UF_NAME'] != ''){ ?>
                                                <? if ($count == 7) { ?>
                                                <select class="mr-3 custom-select" name="Year of issue">
                                                    ...
                                                    <? } else { ?>
                                                        <div class="mr-3 form_radio_btn">
                                                            <input id="carYear<?= $item['UF_NAME'] ?>" type="radio"
                                                                <?= ($item['UF_NAME'] == $arProps['PROP_YAERH']['VALUE']) ? 'checked' : '' ?>
                                                                   data-id-self="<?= $item['UF_NAME'] ?>"
                                                                   data-id_prop="PROP_YAERH"
                                                                   name="Year of issue"
                                                            >
                                                            <label for="carYear<?= $item['UF_NAME'] ?>"><?= $item['UF_NAME'] ?> <?= ($arItem['IS_REQUIRED'] == 'Y') ? '*' : '' ?></label>
                                                        </div>
                                                    <? } ?>
                                                    <? $count++; ?>
                                                    <? }
                                            ...
                                            <div class="d-none d-lg-block col-2">
                                                <p class="m-0 font-weight-bold"><?= Loc::getMessage('Year of issue'); ?>
                                                    : <?= ($prop_field[119]['IS_REQUIRED'] == 'Y') ? '*' : '' ?></p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12 col-lg-10">
                                                <div class="mb-0 form-group">
                                                    <input id="Modification" type="text"
                                                           ...
                                                           class="form-control"
                                                        <?= ($arProps["PROP_MOD"]['VALUE']) ? 'value="' . $arProps["PROP_MOD"]['VALUE'] . '"' : '' ?>
                                                           placeholder="Modification (optional):" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-4 row flex-column-reverse flex-lg-row select-w-100">
                                            <div class="col col-lg-10"><?
                                                ...
                                                foreach ($prop_fields as $field) {
                                                    ...
                                                    if ($pos == 1 && $pos2 == null) {
                                                        if ($field['PROPERTY_TYPE'] == 'L') {
                                                            $db_enum_list = CIBlockProperty::GetPropertyEnum($field['ID'], array(), array("IBLOCK_ID" => 8, 'PROPERTY_ID' => $field['ID']));
                                                ...
                                                <div class="mr-2 mr-lg-3 d-flex flex-wrap auto-ad-step3__colors"
                                                     style="justify-content: end !important;">
                                                    <? foreach ($elCol as $color) {
                                                        if ($color['UF_XML_ID'] != null) {
                                                            ?>
                                                            <input type="radio" data-id_prop="PROP_5"
                                                                   data-id-self="<?= $color['UF_XML_ID'] ?>"
                                                                   class="d-none"
                                                                   name="color" id="<?= $color['UF_NAME'] ?>"
                                                                <?= ($arProps["PROP_5"]['VALUE'] == $color['UF_XML_ID']) ? 'checked' : '' ?>
                                                            >
                                        ...
                                        <? foreach ($arProp as $arItem) { ?>
                                            <? if ($arItem['PROPERTY_TYPE'] == 'L' && $arItem['ID'] != 19 && $arItem['ID'] != 163) { ?>
                                                ...
                                                <div class="mb-4 row flex-column-reverse flex-lg-row select-w-100">
                                                    <div class="col col-lg-10">
                                                        <div class="d-none d-lg-flex justify-content-end">
                                                            ...
                                                            <? if ($arItem['ID'] == 20) { ?>
                                                                <div class="d-none d-lg-flex mr-2 mr-lg-3 mb-2 mb-lg-3 form-group">
                                                                    <input id="millage" class=" form-control"
                                                                           value="<?= (int)$arProps['PROP_PROBEG']['VALUE'] ?>"
                                                                           data-id_prop="19" type="number"
                                                                           placeholder="0"
                                                                           required>
                                                                </div>
                                                                <?
                                                            ...
                                                            if ($arItem['ID'] == 162) { ?>
                                                                <div class="d-none d-lg-flex mr-2 mr-lg-3 mb-2 mb-lg-3 form-group">
                                                                    <input id="PROP_ENGIEN_NEW" class=" form-control"
                                                                           value="<?= (int)$arProps['PROP_ENGIEN_NEW']['VALUE'] ?>"
                                                                           data-id_prop="PROP_ENGIEN_NEW" type="number"
                                                                           placeholder="0"
                                                                           required="">
                                                                </div>
                                                            <? } ?>
                                                ...
                                                <?
                                            } elseif ($arItem['PROPERTY_TYPE'] == 'N' && $arItem['ID'] != 19 && $arItem['ID'] != 163) { ?>
                                ...
                                <div class="wizard-content" data-wizard-content="4">
                                    <div class="auto-ad-step3">
                                        <h2 class="mb-4 d-none d-lg-block text-center text-uppercase font-weight-bolder auto-step2__title">
                                            <?= Loc::getMessage('Detailed description'); ?></h2>
                                        ...
                                        foreach ($prop_fields as $field) {
                                            ...
                                            $pos = strripos($field['CODE'], $needle);
                                            $pos2 = strripos($field['CODE'], $needle2);
                                            if ($pos == 1 && $pos2 >= 10 && $field['MULTIPLE'] == 'Y') {
                                                if ($field['PROPERTY_TYPE'] == 'L') {
                                                    $db_enum_list = CIBlockProperty::GetPropertyEnum($field['ID'], array(), array("IBLOCK_ID" => 8, 'PROPERTY_ID' => $field['ID']));
                                                    while ($ar_enum_list[] = $db_enum_list->GetNext()) {
                                                        $field['PROP_ENUM_VAL'] = $ar_enum_list;
                                        ...
                                        <div class="d-flex flex-column flex-lg-row justify-content-center align-items-center">
                                            <div class="d-flex mb-4 mb-lg-0">
                                                ...
                                                <div class="mr-4 d-flex justify-content-center align-items-center">
                                                    ...
                                                    <label class="steps-check-box"
                                                           for="PriceExchangeIsPossible"></label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex flex-column contact__main">
                                            <div class="mb-4 d-flex justify-center div-req">
                                                ...
                                                <div class="mr-2 form_radio_btn">
                                                    <input data-id-self="133" id="forAutohouse" type="radio"
                                                           name="thisUserStatus"
                                                ...
                                                <div class="form_radio_btn">
                                                    <input data-id-self="132" id="forOwner" type="radio"
                                                           data-id_prop="UF_SELLER_TYPE"
                                            ...
                                            <div class="agency">
                                                <div class="form-group">
                                                    <input data-id-self="Legalname" id="Legalname" class="form-control"
                                                           type="text"
                                                           value="<?= $arProps['UF_NAME']['VALUE'] ?>"
                                                           placeholder="<?= Loc::getMessage('Legal name'); ?>"
                                                           required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="number-section">
                                                <div class="form-group">
                                                    <input data-id-self="phone1" id="phone1" class="form-control"
                                                           type="text"    value="<?= $arProps['UF_PHONE_1']['VALUE'] ?>"
                                                ...
                                                <div class="form-group">
                                                    <input data-id-self="phone2" id="phone2" class="form-control"
                                                           type="text"     value="<?= $arProps['UF_PHONE_2']['VALUE'] ?>"
                                                           placeholder="<?= Loc::getMessage('Enter your phone number in international format'); ?>"
                                                           required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <input data-id-self="phone3" id="phone3" class="form-control"
                                                           type="text" value="<?= $arProps['UF_PHONE_3']['VALUE'] ?>"
                                                           placeholder="<?= Loc::getMessage('Enter your phone number in international format'); ?>"
                                                           required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-4 row flex-column-reverse flex-lg-row property-step-contact__time">
                                                <div class="d-none d-lg-flex col-3">
                                                    <div class="form_radio_btn">
                                                        <input  <?= ($arProps["UF_CALL_ANYTIME"]['VALUE'] != '') ? 'checked' : '' ?> id="anytime" type="checkbox" name="anytime"
                                                               value="anytime">
      ...
      <div class="d-flex flex-column justify-content-center align-items-center">
        ...
        $('.property-step-contact').click(function () {
            ...
            $(this).find('input').each(function () {
                ...
                if ($(this).attr('id') === 'Legalname') {
                    if ($('#forAutohouse').is(':checked')) {
                ...
                if (inputData.req === 'Y') {
                    if ($(this).attr('type') == 'radio') {
                        ...
                        if (value === '') {
                            ...
                            $(this).css('border-block-color', '#ffffff')
                        }
                    }
                }
