...
<div class="container">
    <div class="d-flex flex-column">
        ...
        <!-- MOTO -->
        <div class="mb-4">
            <p class="h2 mb-4 subtitle"><?=Loc::getMessage('MOTO');?></p>
            <?php
        ...
        <!-- SCOOTER -->
        <div class="mb-4">
            <p class="h2 mb-4 subtitle"><?=Loc::getMessage('SCOOTER');?></p>
            <?php
        ...
        <!-- FLEA-MARKET -->
        <div class="mb-4">
            <p class="h2 mb-4 subtitle"><?=Loc::getMessage('FLEA_MARKET');?></p>
            <?php
